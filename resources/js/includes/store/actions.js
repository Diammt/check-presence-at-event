export default {
    ...
    //HEADER
        setActivePage ( {commit}, active_page){
            commit('header/SET_ACTIVE_PAGE', active_page)
        },
        setFixedHeader ( {commit}, fixed_header){
            commit('header/SET_FIXED_HEADER', fixed_header)
        },
    //HEADER
